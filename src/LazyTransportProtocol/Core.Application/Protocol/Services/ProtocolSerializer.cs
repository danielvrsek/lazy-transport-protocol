...
namespace LazyTransportProtocol.Core.Application.Protocol.Services
{
	...
	{
		public string Serialize(string identifier, string headers, string body, AgreedHeadersDictionary agreedHeaders)
		{
			return Serialize(identifier, headers, body, agreedHeaders, agreedHeaders.ProtocolVersion);
		}

		public string Serialize(string identifier, string headers, string body, AgreedHeadersDictionary agreedHeaders, ProtocolVersion protocolVersion)
		{
